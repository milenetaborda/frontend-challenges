            ...
            <div className="flex flex-1 flex-col gap-3 p-5">
              <span
                ...
                {...(!shouldShowOnboarding && {
                  ...
                  className:
                    "flex gap-2 text-sm font-medium text-slate-300 cursor-pointer hover:underline",
                })}
              >
                {!shouldShowOnboarding && <ArrowLeft className="size-5" />}
                {shouldShowOnboarding ? "Adicionar nota" : "Voltar"}
              </span>
